...
func TestHasSourceChanged(t *testing.T) {
	...
	_ = os.WriteFile(sourceFile, []byte(sourceContent), 0600)
...
package main
`
	_ = os.WriteFile(generatedFile, []byte(generatedContent), 0600)
	...
	_ = os.WriteFile(sourceFile, []byte(modifiedContent), 0600)
...
func TestHasSourceChanged_NoGeneratedFile(t *testing.T) {
	...
	_ = os.WriteFile(sourceFile, []byte("package main"), 0600)
...
func TestHasSourceChanged_NoSourceFile(t *testing.T) {
	...
	_ = os.WriteFile(generatedFile, []byte("package main"), 0600)
...
func TestCalculateFileChecksum_EmptyFile(t *testing.T) {
	...
	_ = os.WriteFile(testFile, []byte(""), 0600)
...
func TestCalculateFileChecksum_LargeFile(t *testing.T) {
	...
	_ = os.WriteFile(testFile, []byte(builder.String()), 0600)
