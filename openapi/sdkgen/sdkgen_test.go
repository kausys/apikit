...
func TestGenerate_Pokemon(t *testing.T) {
	...
	// Verify config
	configContent, err := os.ReadFile(filepath.Join(tmpDir, "config", "config.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	sdkRoot, err := os.ReadFile(filepath.Join(tmpDir, "pokemon.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	typesContent, err := os.ReadFile(filepath.Join(tmpDir, "types.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	pokemonSvc, err := os.ReadFile(filepath.Join(tmpDir, "services", "pokemon_service.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	abilitySvc, err := os.ReadFile(filepath.Join(tmpDir, "services", "ability_service.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	pokemonModel, err := os.ReadFile(filepath.Join(tmpDir, "models", "pokemon.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	commonModel, err := os.ReadFile(filepath.Join(tmpDir, "models", "common.go")) //nolint:gosec // test file path is safe
	require.NoError(t, err)
	...
	for _, mf := range modelFiles {
		content, _ := os.ReadFile(mf) //nolint:gosec // test file path from tmpDir
